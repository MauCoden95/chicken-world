        ...
        <div id="header-top">
            <div class="center">
                ...
                <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a class="nav-link text-dark text-center link-login" aria-current="page" href="route('logout')" onclick="event.preventDefault();
                                                this.closest('form').submit();">Cerrar sesión <i class="fas fa-sign-out"></i></a>

                </form>

                <strong>| Bienvenido, {{ Auth::user()->name }} <i class="fas fa-user"></i></strong>
            </div>
        </div>
        <header id="header">
            <div class="center">
